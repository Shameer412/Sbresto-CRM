    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 text-gray-800">
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">Lead Updated Successfully!</h2>
          <p className="text-gray-600 mb-6">The changes have been saved.</p>
          <a href="/employee/leadlist" className="inline-block px-6 py-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-colors">
            Back to Leads
          </a>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-800">
            Edit Lead: <span className="text-blue-600">{formData.full_name}</span>
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Personal Information</h3>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Full Name</label>
                <input name="full_name" value={formData.full_name || ''} onChange={handleChange}
                  className="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"/>
              </div>
              <div>
            ...
            {/* --- Property Info --- */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Property Information</h3>
              <div>
            ...
            {/* --- Insurance Info --- */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Insurance Information</h3>
              <div>
            ...
            {/* --- Roof Info --- */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Roof Information</h3>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Age of Roof</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Retail Bid Request</label>
            ...
            {/* --- Lead Management --- */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Lead Management</h3>
              <div>
            ...
            {/* --- Dates & Assignment --- */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Dates & Assignment</h3>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Storm Date</label>
                <DatePicker
            ...
            <div className="md:col-span-2 lg:col-span-3 space-y-4">
              <h3 className="text-lg font-semibold text-blue-600 border-b border-gray-200 pb-2">Notes</h3>
              <textarea
                name="notes"
