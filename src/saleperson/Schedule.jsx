            ...
            <div className="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700">
              ...
              <div className="mt-6 pt-4 border-t border-gray-700">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-indigo-400 font-bold">{getWeeklyTotal()}h</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700">
              ...
              <div>
                {schedules[activeDay]?.length === 0 ? (
                  <div className="text-center py-12 rounded-lg border-2 border-dashed border-gray-700 text-gray-400">
                    <Clock className="w-12 h-12 mx-auto mb-4 opacity-40" />
                    <p>No time slots scheduled</p>
                    <button
                      onClick={() => addTimeSlot(activeDay)}
                      className="mt-3 font-medium text-indigo-400 hover:text-indigo-300"
                    >
                      + Add first slot
                    </button>
                  </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border border-gray-600 bg-gray-700 rounded-lg text-white focus:ring-indigo-500 focus:border-indigo-500"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <div className="px-3 py-2 bg-gray-600 rounded-lg text-sm text-gray-200">
                              {(() => {
                                const start = new Date(`2024-01-01T${slot.start_time}`);
                                const end = new Date(`2024-01-01T${slot.end_time}`);
                          ...
                          <div className="md:col-span-2 flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-2 rounded-lg transition-colors duration-200 text-red-400 hover:bg-gray-600"
                ...
                {/* Status Messages */}
                {isSuccess && (
                  <div className="mt-4 p-3 rounded-lg flex items-center bg-green-900 text-green-200">
                ...
                {error && (
                  <div className="mt-4 p-3 rounded-lg flex items-center bg-red-900 text-red-200">
                ...
                {DAYS.map(day => (
                  ...
                  >
                    ...
                    <div className={`text-lg font-bold mt-1 ${
                      activeDay === day.key ? 'text-white' : 'text-indigo-400'
                    }`}>
                      {getTotalHours(day.key)}h
                    </div>
                    <div className={`text-xs mt-1 ${
                      activeDay === day.key ? 'text-indigo-100' : 'text-gray-400'
                    }`}>
