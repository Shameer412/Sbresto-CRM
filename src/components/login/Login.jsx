    ...
    <div className="sbr-login-container">
      ...
      <div className="sbr-login-card">
        <div className="sbr-company-header">
          ...
          <p className="sbr-company-tagline">
            Building relationships far beyond any single project.
          </p>
        </div>
        <form onSubmit={handleSubmit} className="sbr-login-form">
          ...
          {/* extra links section */}
          <div className="sbr-extra-links">
            <Link to="/forgot-password" className="sbr-forgot-password">
              Forgot your password?
            </Link>
            <span> · </span>
            <Link to="/signup" className="sbr-signup-link">
              Sign up
            </Link>
          </div>
        </form>
